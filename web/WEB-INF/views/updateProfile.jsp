            ...
            <div class="row">
                <form:form modelAttribute="user" action="/updateProfile" method="post">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        ...
                        <div class="right">
                            <form:input path="Name" id="name" type="text" cssClass="form-control"></form:input>
                            <br>
                        </div>
                        ...
                        <div class="right">
                            <form:input path="DateOfBirth" id="dob" type="String" cssClass="form-control"></form:input>
                            (YYYY-MM-DD)
                            <br>
                            <br>
                        </div>
                        ...
                        <div class="right">
                            <form:input path="AnnualIncome" id="income" type="text" cssClass="form-control"></form:input>
                            <br>
                        </div>
                        ...
                        <div class="right">
                            <form:input path="Mobile" id="mobile" type="text" cssClass="form-control"></form:input>
                            <br>
                        </div>
